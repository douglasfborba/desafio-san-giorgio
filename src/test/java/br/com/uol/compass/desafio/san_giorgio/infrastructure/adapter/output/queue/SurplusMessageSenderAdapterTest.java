...
class SurplusMessageSenderAdapterTest {
    ...
    @InjectMocks
    private SurplusMessageSenderAdapter surplusMessageSender;
    ...
    void shouldSendPaymentMessageSuccessfully() throws Exception {
        ...
        surplusMessageSender.send(item);
    ...
    void shouldThrowSendMessageErrorExceptionWhenCatchUnexpectedError() throws Exception {
        var item = PaymentItemFactory.createSurplusPaymentItem();
